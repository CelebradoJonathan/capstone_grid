...
# friday: verify download duplicate of languages | start api | redirect downloaded files
import requests
...
def download_file(url, filename):
    with open("{}{}{}{}{}".format(os.path.abspath(os.path.dirname(__name__)), os.sep, "downloads", os.sep, filename), "wb") as file:
        response = get(url)
